...
def train_one_epoch(model: torch.nn.Module, criterion: torch.nn.Module,
    ...
    for step, data in enumerate(data_loader):
        ...
        with amp_autocast():
            pred = model(f_in=data.x, batch=data.batch, 
                #node_atom=data.z,edge_index=data.edge_index,edge_attr=edge_attr,
                node_atom=data.z, edge_src=data.edge_src, edge_dst=data.edge_dst,edge_attr=data.edge_attr,
                edge_vec=data.edge_vec, edge_num = data.edge_num)
                #edge_d_index=data.edge_d_index, edge_d_attr=data.edge_d_attr,
                #edge_src=data.edge_src, edge_dest=data.edge_dest, edge_vec=data.edge_vec, 
