...
def main(args):
    ...
    ''' Dataset '''
    train_dataset = MP(args.data_path, 'train', feature_type=args.feature_type)
    val_dataset   = MP(args.data_path, 'valid', feature_type=args.feature_type)
    test_dataset  = MP(args.data_path, 'test', feature_type=args.feature_type)
