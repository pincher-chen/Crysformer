...
def get_radius_graph(num_atoms, frac_coords, lattices, batch, max_radius, max_num_neighbors):
    lattice_nodes = lattices[batch]
    cart_coords = torch.einsum('bi,bij->bj', frac_coords, lattice_nodes)

    edge_index, to_jimages, num_bonds = radius_graph_pbc(
        cart_coords, None, None, num_atoms, max_radius, max_num_neighbors,
    ...
    edge_src = edge_index_new[0]
    edge_dest = edge_index_new[1]
    edge_vec = -edge_vector_new
    distance = edge_vec.norm(dim=-1)
